...
document.getElementById("operatorNameDimAfterCoating").value = "<?= $tracabilitySheet->operatorNameDimAfterCoating ?>";
document.getElementById("lengthL").value = "<?= $tracabilitySheet->lengthL ?>";
document.getElementById("diameterD").value = "<?= $tracabilitySheet->diameterD ?>";
document.getElementById("massM").value = "<?= $tracabilitySheet->massM ?>";
document.getElementById("aspectDimAfterCoating").value = "<?= $tracabilitySheet->aspectDimAfterCoating ?>";
document.getElementById("profileMassBeforeShrinkFit").value = "<?= $tracabilitySheet->profileMassBeforeShrinkFit ?>";
document.getElementById("linearMassBeforeShrinkFit").value = "<?= $tracabilitySheet->linearMassBeforeShrinkFit ?>";
document.getElementById("thickness1BeforeShrinkFit").value = "<?= $tracabilitySheet->thickness1BeforeShrinkFit ?>";
document.getElementById("thickness2BeforeShrinkFit").value = "<?= $tracabilitySheet->thickness2BeforeShrinkFit ?>";
document.getElementById("thickness3BeforeShrinkFit").value = "<?= $tracabilitySheet->thickness3BeforeShrinkFit ?>";
document.getElementById("thickness4BeforeShrinkFit").value = "<?= $tracabilitySheet->thickness4BeforeShrinkFit ?>";
document.getElementById("thickness5BeforeShrinkFit").value = "<?= $tracabilitySheet->thickness5BeforeShrinkFit ?>";
document.getElementById("force1BeforeShrinkFit").value = "<?= $tracabilitySheet->force1BeforeShrinkFit ?>";
document.getElementById("force2BeforeShrinkFit").value = "<?= $tracabilitySheet->force2BeforeShrinkFit ?>";
document.getElementById("force3BeforeShrinkFit").value = "<?= $tracabilitySheet->force3BeforeShrinkFit ?>";
document.getElementById("force4BeforeShrinkFit").value = "<?= $tracabilitySheet->force4BeforeShrinkFit ?>";
document.getElementById("force5BeforeShrinkFit").value = "<?= $tracabilitySheet->force5BeforeShrinkFit ?>";
document.getElementById("aspectFiber1BeforeShrinkFit").value = "<?= $tracabilitySheet->aspectFiber1BeforeShrinkFit ?>";
document.getElementById("aspectFiber2BeforeShrinkFit").value = "<?= $tracabilitySheet->aspectFiber2BeforeShrinkFit ?>";
document.getElementById("aspectFiber3BeforeShrinkFit").value = "<?= $tracabilitySheet->aspectFiber3BeforeShrinkFit ?>";
document.getElementById("aspectFiber4BeforeShrinkFit").value = "<?= $tracabilitySheet->aspectFiber4BeforeShrinkFit ?>";
document.getElementById("aspectFiber5BeforeShrinkFit").value = "<?= $tracabilitySheet->aspectFiber5BeforeShrinkFit ?>";
document.getElementById("averageBeforeShrinkFit").value = "<?= $tracabilitySheet->averageBeforeShrinkFit ?>";
document.getElementById("sigmaBeforeShrinkFit").value = "<?= $tracabilitySheet->sigmaBeforeShrinkFit ?>";
document.getElementById("profileMassAfterShrinkFit").value = "<?= $tracabilitySheet->profileMassAfterShrinkFit ?>";
document.getElementById("linearMassAfterShrinkFit").value = "<?= $tracabilitySheet->linearMassAfterShrinkFit ?>";
document.getElementById("thickness1AfterShrinkFit").value = "<?= $tracabilitySheet->thickness1AfterShrinkFit ?>";
document.getElementById("thickness2AfterShrinkFit").value = "<?= $tracabilitySheet->thickness2AfterShrinkFit ?>";
document.getElementById("thickness3AfterShrinkFit").value = "<?= $tracabilitySheet->thickness3AfterShrinkFit ?>";
document.getElementById("thickness4AfterShrinkFit").value = "<?= $tracabilitySheet->thickness4AfterShrinkFit ?>";
document.getElementById("thickness5AfterShrinkFit").value = "<?= $tracabilitySheet->thickness5AfterShrinkFit ?>";
document.getElementById("force1AfterShrinkFit").value = "<?= $tracabilitySheet->force1AfterShrinkFit ?>";
document.getElementById("force2AfterShrinkFit").value = "<?= $tracabilitySheet->force2AfterShrinkFit ?>";
document.getElementById("force3AfterShrinkFit").value = "<?= $tracabilitySheet->force3AfterShrinkFit ?>";
document.getElementById("force4AfterShrinkFit").value = "<?= $tracabilitySheet->force4AfterShrinkFit ?>";
document.getElementById("force5AfterShrinkFit").value = "<?= $tracabilitySheet->force5AfterShrinkFit ?>";
document.getElementById("aspectFiber1AfterShrinkFit").value = "<?= $tracabilitySheet->aspectFiber1AfterShrinkFit ?>";
document.getElementById("aspectFiber2AfterShrinkFit").value = "<?= $tracabilitySheet->aspectFiber2AfterShrinkFit ?>";
document.getElementById("aspectFiber3AfterShrinkFit").value = "<?= $tracabilitySheet->aspectFiber3AfterShrinkFit ?>";
document.getElementById("aspectFiber4AfterShrinkFit").value = "<?= $tracabilitySheet->aspectFiber4AfterShrinkFit ?>";
document.getElementById("aspectFiber5AfterShrinkFit").value = "<?= $tracabilitySheet->aspectFiber5AfterShrinkFit ?>";
document.getElementById("averageAfterShrinkFit").value = "<?= $tracabilitySheet->averageAfterShrinkFit ?>";
document.getElementById("sigmaAfterShrinkFit").value = "<?= $tracabilitySheet->sigmaAfterShrinkFit ?>";
...
document.getElementById("operatorConformityDeclaration").value = "<?= $tracabilitySheet->operatorConformityDeclaration ?>";
document.getElementById("operatorRemarks").value = "<?= $tracabilitySheet->operatorRemarks ?>";
document.getElementById("dateOperatorConformityDeclaration").value = "<?= $tracabilitySheet->dateOperatorConformityDeclaration ?>";
document.getElementById("operatorNameConformityDeclaration").value = "<?= $tracabilitySheet->operatorNameConformityDeclaration ?>";
document.getElementById("firstAccumulatorLot").value = "<?= $tracabilitySheet->firstAccumulatorLot ?>";
