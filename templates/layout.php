...
<body>
    ...
    <header class="navbar navbar-expand-lg bd-navbar sticky-top">
        <nav class="container-xxl bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main navigation">
            ...
            <a class="navbar-brand" href="https://mediumaquamarine-toad-850598.hostingersite.com/index.php" aria-label="Parker">
                <img src="templates/img/logo parker_crop.png" alt="Bootstrap" height="30">
            </a>
            </a>

            <div class="d-flex">
                <div class="bd-search" id="docsearch" data-bd-docs-version="5.3"><button type="button" class="DocSearch DocSearch-Button" aria-label="Search"><span class="DocSearch-Button-Container"><svg width="20" height="20" class="DocSearch-Search-Icon" viewBox="0 0 20 20" aria-hidden="true">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center justify-content-between active" aria-current="true" href="/docs/5.3/customize/color-modes/">
                                        Latest (5.3.x)
                                        <svg class="bi">
